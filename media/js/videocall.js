...
//
// 		var server = "ws://" + "92.222.242.247" + ":8188";
//
...
$(document).ready(function() {
    ...
    $('body').on('click', '.video .new-call', function() {
        var uname = $('.tribe-pad').data('uname');
        if($(this).closest('.action-item').hasClass('connected')) {
            ...
            console.log(uname);
            doCall(uname);
            $(this).closest('.action-item').addClass('connected');
